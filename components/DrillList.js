...
const DrillList = ({drills, onPressDrill, isLoading, hasError, reload}) => {
                        ...
                        <FlatList
                            ...
                            renderItem={({item}) => (
                                <TouchableOpacity style={{width: '32%', marginHorizontal: 2, marginBottom: 10}}
                                    ...
                                    <Image source={{ uri: `${item.demos.frontThumbnail.fileLocation}` }} style={{width: imageDimension, height: imageDimension, borderRadius: 10}} />
